			...
			cd(heating_data_dir*"/"*Node);
				...
				if Plant == "D"
					...
					for j = 1:3
						...
						if j == 3
							...
							D_data_heating = insert!(D_data_heating, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
														
				global D_data_heating = insert!(D_data_heating, j+5, date_column.date, Symbol.("Date"));
				...
				global C_data_heating = insert!(C_data_heating, j, column.w, Symbol.("TempPlant$sensor_number"));
						...
						if j == 3
							...
							C_data_heating = insert!(C_data_heating, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
														
				global C_data_heating = insert!(C_data_heating, j+5, date_column.date, Symbol.("Date"));
				...
				if Plant == "D"
					...
					for j = 1:3
						...
						if j == 3
							...
							D_data_otc = insert!(D_data_otc, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
														
				global D_data_otc = insert!(D_data_otc, j+5, date_column.date, Symbol.("Date"));
				...
				elseif Plant == "C"
					...
					for j = 1:3
						...
						if j == 3
							...
							C_data_otc = insert!(C_data_otc, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
							global C_data_otc = insert!(C_data_otc, j+5, date_column.date, Symbol.("Date"));
				...
				if Plant == "D"
					...
					for j = 1:3
						...
						if j == 3
							...
							D_data_openspace = insert!(D_data_openspace, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
														
				global D_data_openspace = insert!(D_data_openspace, j+5, date_column.date, Symbol.("Date"));
				...
				elseif Plant == "C"
					...
					for j = 1:3
						...
						if j == 3
							...
							C_data_openspace = insert!(C_data_openspace, j+4, ambient_column.u, Symbol.("Ambient_1_$sensor_number"));
							global C_data_openspace = insert!(C_data_openspace, j+5, date_column.date, Symbol.("Date"));
